...
class PostController extends Controller
{
    ...
    public function home()
    {
        ...
        $popularPost = Post::query()
            ...
            ->groupBy('posts.id', 'posts.title', 'posts.slug', 'posts.thumnail', 'posts.body', 'posts.active', 'posts.published_at', 'posts.user_id', 'posts.created_at', 'posts.updated_at', 'posts.meta_title', 'meta_description')
            ->limit(3)
            ->get();
